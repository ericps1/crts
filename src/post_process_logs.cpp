...
int main(int argc, char ** argv){
	...
	fprintf(file_out, "\nfigure;\n");
	fprintf(file_out, "plot(t,Header_valid);\n");
	...
	fprintf(file_out, "\nfigure;\n");
	fprintf(file_out, "plot(t,Payload_valid);\n");
