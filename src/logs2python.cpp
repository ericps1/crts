...
void help_logs2python() {
  ...
  printf("               The new file can then be imported into a Python "
...
int main(int argc, char **argv) {
  ...
  enum log_t { RXMETRICS = 0, TXPARAMS, INTPARAMS };
  ...
  if (strcmp(output_file + (strlen(output_file) - strlen(fileExtension)),
             fileExtension))
