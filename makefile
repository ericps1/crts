...
#EDIT SC START FLAG
SCs = src/SC.cpp scenario_controllers/SC_BER_Sweep.cpp scenario_controllers/SC_Control_and_Feedback_Test.cpp scenario_controllers/SC_Scoreboard.cpp scenario_controllers/SC_CORNET_Tutorial.cpp scenario_controllers/SC_Network_Loading.cpp scenario_controllers/SC_Template.cpp
#EDIT SC END FLAG
