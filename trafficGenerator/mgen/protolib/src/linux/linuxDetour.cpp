...
// The change to the nfq_get_payload() prototype seemed to kick in around Linux header files
// version 3.5?  (This will probably need to be fine tuned for the right version threshold.)
...
#if ((LINUX_VERSION_MAJOR > 3) || ((LINUX_VERSION_MAJOR == 3) && (LINUX_VERSION_MINOR > 4)))
